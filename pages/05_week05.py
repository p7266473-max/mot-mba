...
st.markdown("## 🔄 Week 5: Systems Development Life Cycles (SDLC)")

# Construct path relative to repo root
base_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

# Load all 25 questions
all_questions = load_week_questions(base_path, 5)
...
if not all_questions:
    ...
    state_key = "sampled_questions_week05"
    ...
    render_quiz_engine("week05", st.session_state[state_key])
