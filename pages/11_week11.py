...
st.markdown("## 🤝 Week 11: Buy vs. Build & SaaS Alternatives")

# Construct path relative to repo root
base_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

# Load all 25 questions
all_questions = load_week_questions(base_path, 11)
...
if not all_questions:
    ...
    state_key = "sampled_questions_week11"
    ...
    render_quiz_engine("week11", st.session_state[state_key])
