...
st.markdown("## 📅 Week 13: Cloud Governance & Continuity Planning")

# Construct path relative to repo root
base_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

# Load all 25 questions
all_questions = load_week_questions(base_path, 13)
...
if not all_questions:
    ...
    state_key = "sampled_questions_week13"
    ...
    render_quiz_engine("week13", st.session_state[state_key])
