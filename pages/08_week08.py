...
st.markdown("## ⚡ Week 8: Legislative Trends & Cloud Infrastructure")

# Construct path relative to repo root
base_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

# Load all 25 questions
all_questions = load_week_questions(base_path, 8)
...
if not all_questions:
    ...
    state_key = "sampled_questions_week08"
    ...
    render_quiz_engine("week08", st.session_state[state_key])
