...
st.markdown("## 🛡️ Week 4: Information Ethics & Privacy")

# Construct path relative to repo root
base_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

# Load all 25 questions
all_questions = load_week_questions(base_path, 4)
...
if not all_questions:
    ...
    state_key = "sampled_questions_week04"
    ...
    render_quiz_engine("week04", st.session_state[state_key])
